...
{
    this->_name = name;
    this->setHit(getInitialHit());
    this->setEnergy(getInitialEnergy());
    this->setAttack(getInitialAttack());
...
int     ClapTrap::getInitialHit() const
{
    return (10);
}

int     ClapTrap::getInitialEnergy() const
{
    return (10);
}

int     ClapTrap::getInitialAttack() const
{
    return (0);
}